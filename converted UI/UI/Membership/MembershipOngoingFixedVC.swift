//
//  MembershipOngoingFixedVC.swift
//  StyleWork
//
...
class MembershipOngoingFixedVC: UIViewController {
    ...
    func addMembershipCard() {
        ...
        let card = MembershipPlansCard(frame: CGRect(x: 0, y: 0, width: width, height: 326))
        view.addSubview(card)
        card.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([card.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 138),
                                     card.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
                                     card.widthAnchor.constraint(equalToConstant: width),
                                     card.heightAnchor.constraint(equalToConstant: 326)])
    }
